...
def get_multistringmatching(filepath):
...
def create_output_file(full_list_of_dicts, filepath):
...
filepath = 'Assignment02/stringmultimatching.in'
full_list_of_dicts = get_multistringmatching(filepath)
print("full_list_of_dicts: ", full_list_of_dicts)
create_output_file(full_list_of_dicts, 'Assignment02/my_stringmultimatching.ans')
